  ...
  return (
    <div className="ui-root">
        <nav className="ui-nav">
          ...
          <button className="nav-btn" onClick={() => navigate("/inventory")}>← All Items</button>
        </nav>
          ...
          <aside className="ui-left">
            ...
            <div className="sidebar-img-wrap">
              ...
              {preview ? (
                ...
                <img className="sidebar-img" src={inventoryApi.getImageUrl(item.itemImage)} alt={item.itemName} />
              ) : (
          ...
          <div className="ui-right">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-actions">
                ...
                <button className="btn-cancel" type="button" onClick={() => navigate("/inventory")}>Cancel</button>
              </div>
            </form>
          </div>
        </main>
