      ...
      <div className="home-root">
        ...
        <nav className="nav">
          ...
          <div className="nav-actions">
            ...
            <button className="btn-ghost" onClick={() => window.location.href="/signin"}>Log in</button>
            <button className="btn-outlined" onClick={() => window.location.href="/signup"}>Join Elymon</button>
          </div>
        </nav>
